    ...
    <div class="col-lg-8">
        <form method="POST" action="/dashboard/posts/{{ $post->slug }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error ('title') is-invalid @enderror" id="title" name="title" placeholder=" Title" onkeyup="createTextSlug()" required autofocus value="{{ old('title', $post->title)}}">
                @error ('title') 
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="excerpt" name="excerpt" rows="3" placeholder="Excerpt" required value="{{ old('excerpt', $post->excerpt)}}"></textarea>
            </div>
            <div class="mb-3">
